...
logging.basicConfig(filename='modbus_server.log',filemode='a', level=logging.DEBUG,
...
def run_modbus_server():
    ...
    context = ModbusServerContext(slaves={0x01: store1, 0x02: store2}, single=False)
    ...
    # Run TCP server
    StartTcpServer(context = context, identity=identity, address=("192.168.1.20", 502), framer=ModbusSocketFramer)
